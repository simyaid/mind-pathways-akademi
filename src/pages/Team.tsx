...
export const team = [
  ...
  },
  {
    ...
    focus: ["Ruh Sağlığı ve Tarihsellik"],
  },
  {
    slug: "gorsel-aymaz",
    name: "Göksel Aymaz",
    ...
    focus: ["Sosyal Teoride İnsan ve Toplum"],
  },
  {
    slug: "hacer-foggo",
    name: "Hacer Foggo",
  ...
  },
  {
    ...
    focus: ["Narsisizm, Oidipus ve Ötesi"],
  },
  {
    slug: "hakan-kocak",
    name: "M. Hakan Koçak",
    ...
    focus: ["Sınıf Deneyimlerinin Ruhsal Dinamikleri"],
  },
  {
    slug: "ismail-gezgin",
    name: "İsmail Gezgin",
  ...
  },
  {
    ...
    focus: ["Halk Ezgileri ve Ruhsallık"],
  },
  {
  ...
  },
  {
    ...
    focus: ["Tragedyalar ve Kahraman Kurban Ruhsallığı"],
  },
  {
    ...
    focus: ["Psikoterapinin Temel İlkeleri Kursu"],
  },
  {
    slug: "zehra-eryoruk",
    name: "Zehra Eryörük",
    ...
    focus: ["Lacan Düşüncesi: Gelişim Koşulları"],
  },
  {
    slug: "ahmet-kilisli",
    ...
    focus: ["Merkezin Dışındaki Sesler: Psikanalizde Dilsel Hegemonya ve Görmezden Gelinen Öncüler"],
  },
  {
    slug: "beril-bayrak",
    name: "Beril Bayrak",
    ...
    focus: ["Bebek Ruhsallığı: Başlangıçlara Dair"],
  },
  {
    slug: "cem-atbasoglu",
    name: "Cem Atbaşoğlu",
    ...
    focus: ["Temel Psikopatoloji Kursu"],
  },
  {
    slug: "emine-ayhan",
    name: "Emine Ayhan",
    ...
    long: "Ankara Üniversitesi, Dil ve Tarih, Coğrafya Fakültesi, İngiliz Dili ve Edebiyatı bölümünden Macbeth ve Machiavelli konulu lisans teziyle 2004'te mezun oldu. Aynı fakültenin Sistematik Felsefe ve Mantık anabilim dalında yüksek lisans derslerini tamamladıktan sonra edebiyat yüksek lisans derecesini Ahmet Hamdi Tanpınar'ın “Abdullah Efendi'nin Rüyaları” hikâyesinde ulusal alegori konulu teziyle Bilgi Üniversitesi Karşılaştırmalı Edebiyat bölümünden aldı. Lewis Hyde, Wendy Brown, Svetlana Boym, Alasdair Gray, Terry Eagleton, Spinoza gibi yazar ve düşünürlerden yaptığı çok sayıda kitap çevirisinin yanısıra şiir, oyun ve makale çevirileri de bulunuyor. 2008'den bu yana disiplinlerarası edebiyat ve tiyatro eleştirisi seminerleri yürütüyor, çeşitli mecralarda yazıyor. 2018'den bu yana Shakespeare oyunlarının eleştirel çeviri edisyonlarını yayına hazırlıyor. Çevirileri Moda Sahnesi tarafından sahnelendi, sahneleniyor. Bu kapsamda yayımlanan ve yayına hazırlanan Shakespeare çevirileri: Bir Yazdönümü Gecesi Rüyası (ortak çeviri-2018), Fırtına (2018), Venedik Taciri (2019), Kral Lear (2019), Şirret Evcilleşmesi (2020), Macbeth Tragedyası (2025), Othello, Venedikli Mağribi Tragedyası (2026).",
    longExtra: "",
    focus: ["Shakespeare ve Psikodiyalektik: Zaman, Mekan, Diyalektik Dönüşüm"],
  },
  {
    slug: "ishak-saygili",
    name: "İshak Sayğılı",
    ...
    long: "Erenköy Ruh ve Sinir Hastalıkları Eğitim ve Araştırma Hastanesi'nde, 2013 yılında psikiyatri uzmanlık eğitimini tamamlamıştır. İstanbul Psikanaliz Derneği üyesi Psikanalisttir. Klinik çalışmalarını kendi özel pratiğinde sürdürmektedir. \"Psikiyatride Sinema, Sinemada Psikiyatri (2010)\", \"Gezi'yi Psikanalizle Düşünmek (2016)\", \"Her Yönüyle Ekmek (2022)\", \"Oidipus – Psikomitoloji 2: Sosyokültürel Açılımlar (2023)\", \"Freud Diye Diye (2025)\", \"Depresyonun Psikanalitik Psikoterapisi (2025)\", \"Beyaz Perdeye Yansıyan Zihin (2025)\" isimli kitaplara bölüm yazarı olarak katkıda bulunmuştur. Psikesinema, Psikeart, Psikanaliz Yazıları, Psikanaliz Defterleri, Psikiyatride Güncel gibi dergilerde yayınlanmış makaleleri vardır.",
    longExtra: "",
    focus: ["Bağlanma - Travma - Utanç"],
  },
  {
    slug: "timucin-oral",
    name: "E. Timuçin Oral",
  ...
  },
  {
    ...
    focus: ["Anadolu Ruhsallığı", "Psikodiyalektik"],
  },
];
                ...
                {member.focus && member.focus.length > 0 && (
                  <div className="mt-4 flex flex-wrap gap-2">
                    {member.focus.map((tag) => (
                      <span key={tag} className="px-3 py-1 rounded-full bg-navy-deep/5 text-navy-deep text-sm font-medium">
                        {tag}
                      </span>
                    ))}
                  </div>
