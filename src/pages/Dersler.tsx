...
const dersler: Ders[] = [
  {
    ...
    content: [
      ...
      { kind: "header", value: "GRUPANALİZ TARİHÇESİ" },
      { kind: "items", values: ["Öncüler", "Fransız okulu", "İngiliz okulu"] },
      { kind: "header", value: "PSİKODİYALEKTİK ÇALIŞMANIN TEMEL UĞRAKLARI" },
  ...
  },
  {
    ...
    content: [
      ...
      { kind: "text", value: "Çifte görünmezliğe uğrayan kadın analistleri de anmadan liste eksik kalır. Psikanaliz tarihinde kurumsal körlüğün, entelektüel tahakkümün ve eril hegemonyanın nasıl çalıştığını göstermek üzere hazırlanan bu çalışmada Sabina Spielrein'den bahsetmeden geçilemez." },
            ...
            >
              <AccordionTrigger className="py-5 hover:no-underline">
                <div className="text-left">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">{d.instructor}</p>
                </div>
              </AccordionTrigger>
              {d.content.length > 0 && (
